...
public class PasswordSelectionTest {
    ...
    public void testRestAssured() {
        ...
        List ListPass = new ArrayList(); // массив с паролями
        ...
        for (int i = 0; i <= ListPass.size() - 1; i++) {
            ...
            Response testLoginPair = RestAssured  //Готовим первый запрос
                    .given()
                    .body(data)
                    .when()
                    .post(Url)
                    .andReturn();
            String responseCookie = testLoginPair.getCookie("auth_cookie"); //Забираем cookie

            Map<String, String> cookies = new HashMap<>();
            cookies.put("auth_cookie", responseCookie);


            Response checkCookie = RestAssured //Проверяем cookie
                    .given()
                    .body(data)
                    .cookies(cookies)
                    .when()
